            ...
            success: function (result, status, xhr) {
                ...
                $.each(result, function (i, item) {
                    ...
                    $.each(item.photo, function(n, pic){
                        console.log(n, pic.id, pic.server, pic.secret);
                        var image = "<div class='col-md-4'><img class='float-left' style='width:100%' src='https://live.staticflickr.com/"+ pic.server + "/"+ pic.id + "_" + pic.secret + ".jpg'></div>"
